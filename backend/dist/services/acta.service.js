...
exports.buildActaHtml = buildActaHtml;
...
function buildHtml(data) {
    ...
    const compromisosRows = data.compromisos.length > 0
        ...
        : Array(7).fill(null).map(() => '<tr><td style="height:22px;"></td><td></td><td></td><td></td></tr>').join('');
...
async function generarActaPDF(data) {
    ...
    const browser = await puppeteer.launch({
        ...
        executablePath: process.env.CHROME_EXECUTABLE_PATH || (await chromium.executablePath(process.env.CHROMIUM_DOWNLOAD_URL)),
